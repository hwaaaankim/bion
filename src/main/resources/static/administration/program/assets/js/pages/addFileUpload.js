...
var dropzone,
    ...
    inputMultipleElements =
        ...
        dropzonePreviewNode &&
            ...
            { 
            url: "/admin/productCenter/addExcelUpload", 
            method: "post", 
...
// dictRemoveFile: '삭제', // 삭제버튼 표시 텍스트
		   ...
		   init: function () {
		      ...
		      document.querySelector('#addExcelUpload').addEventListener('click', function () {
		         console.log('업로드');
		      ...
		      this.on('addedfile', function (file) {
				  $('#addExcelUpload').attr('disabled', false);
		         // 중복된 파일의 제거
		      });
...
var secdropzone,
    ...
    inputMultipleElements =
        ...
        secdropzonePreviewNode &&
            ...
            (secdropzone = new Dropzone(".sec.dropzone", 
            		{ 
            	url: "/admin/productCenter/addZipUpload", 
	            method: "post", 
	            previewTemplate: previewTemplate, 
	...
	// dictRemoveFile: '삭제', // 삭제버튼 표시 텍스트
			   ...
			   init: function () {
			      ...
			      // 서버에 제출 submit 버튼 이벤트 등록
			      document.querySelector('#addFileUpload').addEventListener('click', function () {
			         console.log('업로드');
			      ...
			      // 파일이 업로드되면 실행
			      this.on('addedfile', function (file) {
					  $('#addFileUpload').attr('disabled', false);
			         // 중복된 파일의 제거
			      });
